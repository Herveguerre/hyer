    ...
    <div className='footer'>
        <div className='footer_container'>
            ...
            <div className='fd'>
                ...
                <div className='f9'>
                    <p>
                    Hyer® est un courtier d'affrètement avec une plateforme numérique mondiale et n'est pas un transporteur aérien direct. Tous les vols annoncés auxquels Hyer® a accès sont détenus et exploités par un transporteur aérien tiers dûment agréé, conformément aux règles définies par l'Agence de la sécurité aérienne de l'Union européenne (ou toute autre autorité compétente en vertu du droit étranger). Hyer® n'a pas d'assurance responsabilité civile supplémentaire. Les passagers sont couverts par l'assurance de l'exploitant de l'avion.
                    </p>
                </div>
